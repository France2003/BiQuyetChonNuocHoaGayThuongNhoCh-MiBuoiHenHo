...
const PageHome = () => {
    return (
        <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
            ...
            <p className='mx-9'><b>Xem thêm:</b> <a style={{ textDecorationLine: 'underline', fontSize: 17 }}  href="https://codedeco.art/bat-mi-cho-nang-5-bi-kip-gay-thuong-nho/?fbclid=IwZXh0bgNhZW0CMTAAAR11OKH0Dl6YUmXReD2zypKQ6yQpRqVOARHL-ZPoCJ6AAYUzTYZUKdRUFMQ_aem_3OFVpKfups6RtdNVI-XU5A">BẬT MÍ CHO NÀNG 5 BÍ KÍP GÂY THƯƠNG NHỚ</a></p>
        </div>
    )
}
