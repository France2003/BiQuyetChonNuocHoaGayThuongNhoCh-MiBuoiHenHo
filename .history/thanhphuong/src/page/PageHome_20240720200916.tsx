        ...
        <div className="mt-32 mb-5  w-[1120px]  flex justify-around flex-col  m-auto leading-7">
            ...
            <div className='mx-9'>
                ...
                <div>
                    ...
                    <p className='text-center italic mb-5'>Nước hoa CODEDECO Rose by Code</p>
                    <div className=''>
            ...
            <p className='mx-9'><b>Xem thêm:</b> <a style={{ textDecorationLine: 'underline', fontSize: 15 }}  href="https://codedeco.art/mach-ban-cach-khac-phuc-nuoc-hoa-co-can/?fbclid=IwZXh0bgNhZW0CMTAAAR11OKH0Dl6YUmXReD2zypKQ6yQpRqVOARHL-ZPoCJ6AAYUzTYZUKdRUFMQ_aem_3OFVpKfups6RtdNVI-XU5A">Mách bạn cách khác phục nước hoa có cặn</a></p>
        </div>
    )
}
